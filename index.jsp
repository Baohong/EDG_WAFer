...
// return a list of xml urls, or null if problems. If recurse is true, search any dirs found in the serviceUrl.
        ...
        if (folder != null)
            ...
            u.transformAndOutput(new StreamSource(u.internal("wafconfig.xml")),
                new StreamSource(u.internal("waflist.xsl")), out);
            }%>
    </BODY>
</HTML>
